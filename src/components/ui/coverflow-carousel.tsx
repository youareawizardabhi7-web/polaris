...
export interface CoverflowCarouselProps {
  ...
  renderSlide?: (slide: CoverflowSlide, index: number) => React.ReactNode;
}
...
export function CoverflowCarousel({
  ...
  falloff = 0.56,
  fade = 0.1,
  cardWidth = "clamp(280px, 32vw, 380px)",
  gap = 0.05,
  loop = true,
  showCaption = false,
  showPagination = true,
          ...
          >
            {slides.map((slide, index) => (
              <div
                ...
                style={{ width: "var(--cf-card)", height: "100%" }}
              >
                {renderSlide ? (
        ...
        {showNavigation && (
          <>
            <button
              ...
              onClick={() => nudge(-1)}
              className="absolute left-3 top-1/2 z-[200] -translate-y-1/2 rounded-full bg-background/70 p-2 text-foreground backdrop-blur transition hover:bg-background shadow-md border border-slate-700/40"
            >
            ...
            <button
              ...
              onClick={() => nudge(1)}
              className="absolute right-3 top-1/2 z-[200] -translate-y-1/2 rounded-full bg-background/70 p-2 text-foreground backdrop-blur transition hover:bg-background shadow-md border border-slate-700/40"
            >
