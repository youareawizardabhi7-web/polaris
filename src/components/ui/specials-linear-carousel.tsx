  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "flex w-full overflow-x-scroll overscroll-x-auto scroll-smooth py-6 [scrollbar-width:none] md:py-10 cursor-grab active:cursor-grabbing",
        ...
        >
          <div
            className={cn(
              "absolute right-0 z-10 h-auto w-[5%] overflow-hidden bg-gradient-to-l from-white dark:from-background to-transparent pointer-events-none",
            )}
          ></div>
        ...
        <div className="flex justify-center gap-3 mt-4">
          <button
            className="relative z-40 flex h-10 w-10 items-center justify-center rounded-full bg-card border border-border hover:bg-muted disabled:opacity-50 transition-colors shadow-md"
            onClick={scrollLeft}
